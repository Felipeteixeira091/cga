        ...
        <div class="container theme-showcase" role="main">
            <div style="margin: 2px;" class="objeto">
                <div id="pa_formulario1" style="display:none" class="card border mt-2 p-1">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <input type="date" class="form-control" id="vfbData1" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                        <div class="col">
                    ...
                    <div class="row mt-3 mb-3">
                        ...
                        <div class="col" style="display:none">
                            <button style="display:none" type="button" class="btn btn-light border text-muted" id="bt_xls" disabled><i class="icon-download-2 text-success"></i> Exportar para .XLS</button>
                        </div>
                        <div class="col">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ml-2 mr-2">
                            ...
                            <div class="row mt-1-sm">
                                <div class="col-md mt-1 ml-1 rounded bg-light border"><span class="font-weight-bold">Serviço aprovado:</span> <span id="vfbOrientacao"></span></div>
                            </div>
                            ...
                            <div class="row mt-2-sm">
                                ...
                                <div class="col-md mt-1">
                                    <button class="btn btn-light text-muted border" id="formCorrecao"><i class='icon-edit text-info'></i> Solicitar correção</button>
                                </div>
                                <div class="col-md mt-1">
