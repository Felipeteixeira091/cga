...
<head>
    ...
    <script src="js/SCE_SOLICITACAO.js<?php echo $versao; ?>"></script>
        ...
        <div class="container theme-showcase" role="main">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            <select class="d-none custom-select mr-sm-2" id="tipo_colaborador"></select>
                            <select class="d-none custom-select mr-sm-2" id="tipo_gmg"></select>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col">
                            <button id="btDados" class="btn btn-sm btn-primary"><i class="icon-database-1"></i> Obter dados</button>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="modal-content">
                        <div class="card mt-2 p-1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-1-sm" id="divGmg">
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        <button class="btn btn-sm btn-primary" id="btSolicita"><i class="icon-ok-circled-1"></i> SOLICITAR</button>
                                    </div>
                                    <div class="col">
                                        <button class="btn btn-sm btn-primary" data-dismiss="modal"><i class="icon-cancel-circled-1"></i> CANCELAR</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
            ...
            <div class="modal bd-example-modal-lg hide fade in" data-keyboard="false" data-backdrop="static" id="sce_modal_valor" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="card mt-2 p-1">
                            <div class="card-header font-weight-bold">Definir valor da solicitação <span id="defId"></span></div>
                            <div class="card-body">
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 bg-light border rounded">
                                        <span class="text-muted">Nome: <span id="defNome"></span><span class="badge badge-light text-right" id="defRe"></span></span>
                                    </div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md-3 mt-1 align-middle bg-light border rounded">
                                        <i class="icon-credit-card"></i> Cartão: <span class="text-muted"><span id="defCartao"></span></span>
                                    </div>
                                    <div class="col-md mt-1 ml-md-1 align-middle bg-light border rounded">
                                        <i class="icon-map"></i> KM: <span class="text-muted"><span id="defKm"></span></span>
                                    </div>
                                    <div class="col-md mt-1 ml-md-1 align-middle bg-light border rounded">
                                        <i class="icon-money"></i> Saldo: <span class="text-muted"><span id="defSaldo"></span></span>
                                    </div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 align-middle bg-light border rounded">
                                        <i class="icon-chat-1"></i> <span class="text-muted"><span id="defObs"></span></span>
                                    </div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1">
                                        <input class="form-control" id="confValor" onkeyup="somenteNumeros(this);" placeholder="Valor solicitado">
                                    </div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1">
                                        <textarea class="form-control" placeholder="Observações" maxlength="140" id="confObs" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col">
                                        <button class="btn btn-sm btn-primary" id="btConfirma"><i class="icon-ok-circled-1"></i> Confirmar</button>
                                    </div>
                                    <div class="col">
                                        <button class="btn btn-sm btn-primary" data-dismiss="modal"><i class="icon-cancel-circled-1"></i> CANCELAR</button>
                                    </div>
