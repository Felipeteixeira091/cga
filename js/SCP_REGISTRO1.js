$(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(dados) {
                            ...
                            if (dados.length === 0) {
                                ...
                                $("#retornoSite").slideDown("fast").addClass(classe).append(dados.msg).delay(tempo).slideUp("fast");
        ...
        $(".btDetalheLancamento").click(function() {
            ...
            $.ajax({
                ...
                success: function(dados) {
                    ...
                    //         $("#SCPObs").text(dados.justificativa);
    ...
    function cadastro() {
        ...
        $.ajax({
            type: 'post', //Definimos o método HTTP usado
            data: { acao: "cadastroSCP", site: site, atividade: atividade, os: os, obs: obs, data1: data1, hora1: hora1, data2: data2, hora2: hora2 },
            dataType: 'json', //Definimos o tipo de retorno
            url: 'SCPREGISTRO', //Definindo o arquivo onde serão buscados os dados
            beforeSend: function() {
