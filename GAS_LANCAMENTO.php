...
<html5>
    ...
    <head>
        ...
        <script src="js/GAS_LANCAMENTO.js<?php echo $versao; ?>"></script>
        ...
        <center>
            <div class="container theme-showcase" role="main">
                ...
                <div id="lc_formulario1" style="display:none" class="card border mt-2 p-1">
                    <div class="card-header font-weight-bold">Utilização de gás</div>
                    <div class="card-body">
                        <div class="row mt-3">
                            <div class="col">
                                <select class="form-control" id="lc_cn"></select>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
                                <span>DATA INICIAL</span>
                                <input type="date" class="form-control" id="lc_DataInicio" value="<?php echo date('Y-m-d');?>">
                            </div>
                            <div class="col">
                                <span>DATA FINAL</span>
                                <input type="date" class="form-control" id="lc_DataFIm" value="<?php echo date('Y-m-d');?>">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
                            ...
                            <div class="col">
                                <button id="btEstoque" class="btn btn-light border"><i class="icon-briefcase-1 text-info"></i> Meu estoque</button>
                            </div>
                            <div class="col">
                ...
                <div class="modal fade" data-keyboard="false" data-backdrop="static" id="DetalheLancamento" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="ModalTitulo">Lançamento de utilização de gás - ID: <span id="LCId"></span></h5>
                            </div>
                            <div class="modal-body m-1">
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 align-middle bg-light border border rounded">
                                        Técnico responsável: <span id="LCTecnicoNOME"></span> - <span id="LCTecnicoRE"></span>
                                    </div>
                                    <div class="col-md mt-1 ml-md-1 align-middle bg-light border border rounded">
                                        Coordenador: <span id="LCCoordenadorNOME"></span> - <span id="LCCoordenadorRE"></span>
                                    </div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 align-middle bg-light border border rounded">Registro: <span id="LCDataRegistro"></span></div>
                                    <div class="col-md mt-1 ml-md-1 align-middle bg-light border border rounded">Data OS: <span id="LCDataOS"></span></div>
                                    <div class="col-md mt-1 ml-md-1 align-middle bg-light border border rounded">OS Prisma: <span id="LCOS"></span></div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 align-middle bg-light border border rounded">Gás: <span id="LCGAS"></span></div>
                                    <div class="col-md mt-1 ml-md-1 align-middle bg-light border border rounded">Kg: <span id="LCQTD"></span></div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 align-middle bg-light border border rounded">CN/SITE: <span id="LCCN_SITE"></span></div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1 align-middle bg-light border border rounded">OBSERVAÇÕES: <span id="LCobs"></span></div>
                                </div>
                                <div class="row mt-1-sm">
                                    <div class="col-md mt-1">
            ...
            <div style="display: none;" id="ListaLC"></div>
        </center>
